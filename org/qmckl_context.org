...
typedef struct qmckl_context_struct {
  ...
  /* Number of OpenMP threads for parallel regions (default: omp_get_max_threads() or 1) */
  int32_t                  num_threads;
...
qmckl_exit_code qmckl_context_get_num_threads(const qmckl_context context, int32_t* const num_threads) {
  ...
  *num_threads = ctx->num_threads;
  return QMCKL_SUCCESS;
   ...
   #+begin_src f90 :tangle (eval fh_func) :exports none
   interface
      integer (qmckl_exit_code) function qmckl_context_get_num_threads(context, num_threads) bind(C)
        use, intrinsic :: iso_c_binding
        import
        integer (qmckl_context), intent(in), value :: context
        integer (c_int32_t), intent(out) :: num_threads
      end function qmckl_context_get_num_threads
   end interface
   #+end_src
...
qmckl_exit_code qmckl_context_set_num_threads(const qmckl_context context, const int32_t num_threads) {
  ...
  return QMCKL_SUCCESS;
   ...
   #+begin_src f90 :tangle (eval fh_func) :exports none
   interface
      integer (qmckl_exit_code) function qmckl_context_set_num_threads(context, num_threads) bind(C)
        use, intrinsic :: iso_c_binding
        import
        integer (qmckl_context), intent(in), value :: context
        integer (c_int32_t), intent(in), value :: num_threads
      end function qmckl_context_set_num_threads
   end interface
   #+end_src
...
qmckl_exit_code qmckl_context_unset_num_threads(const qmckl_context context) {
  ...
  return QMCKL_SUCCESS;
   ...
   #+begin_src f90 :tangle (eval fh_func) :exports none
   interface
      integer (qmckl_exit_code) function qmckl_context_unset_num_threads(context) bind(C)
        use, intrinsic :: iso_c_binding
        import
        integer (qmckl_context), intent(in), value :: context
      end function qmckl_context_unset_num_threads
   end interface
   #+end_src
...
{
  int32_t initial_num_threads;
  assert(qmckl_context_get_num_threads(context, &initial_num_threads) == QMCKL_SUCCESS);
  assert(initial_num_threads > 0);

  int32_t nt;

  assert(qmckl_context_set_num_threads(context, 1) == QMCKL_SUCCESS);
  assert(qmckl_context_get_num_threads(context, &nt) == QMCKL_SUCCESS);
  assert(nt == 1);

  assert(qmckl_context_set_num_threads(context, 2) == QMCKL_SUCCESS);
  assert(qmckl_context_get_num_threads(context, &nt) == QMCKL_SUCCESS);
  assert(nt == 2);

  assert(qmckl_context_unset_num_threads(context) == QMCKL_SUCCESS);
  assert(qmckl_context_get_num_threads(context, &nt) == QMCKL_SUCCESS);
  assert(nt == initial_num_threads);

  assert(qmckl_context_set_num_threads(context, 0) == QMCKL_INVALID_ARG_2);
  assert(qmckl_context_set_num_threads(context, -1) == QMCKL_INVALID_ARG_2);

  assert(qmckl_context_get_num_threads(QMCKL_NULL_CONTEXT, &nt) == QMCKL_INVALID_CONTEXT);
  assert(qmckl_context_get_num_threads(context, NULL) == QMCKL_INVALID_ARG_2);
  assert(qmckl_context_set_num_threads(QMCKL_NULL_CONTEXT, 1) == QMCKL_INVALID_CONTEXT);
  assert(qmckl_context_unset_num_threads(QMCKL_NULL_CONTEXT) == QMCKL_INVALID_CONTEXT);
}
   #+end_src
